    ...
    while($row = mysqli_fetch_assoc($result)) {
        if ($g_email === $row['Email']) {
            ...
            if ($db_department === 'English' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/HoD/English/english_hod.html", true, 301);
            } 
            elseif ($db_department === 'Hindi' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/HoD/Hindi/hindi_hod.html", true, 301);
            }
            elseif ($db_department === 'Mathematics' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/HoD/Maths/maths_hod.html", true, 301);
            }
            elseif ($db_department === 'Science' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/HoD/Science/science_hod.html", true, 301);
            }
            elseif ($db_department === 'Social Science' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/HoD/SSc/ssc_hod.html", true, 301);
            }
            elseif ($db_department === 'Information Technology' && $db_designation === "HoD") {
                header("Location: https://m.tsh.edu.in/it_hod.html", true, 301);
            }
            elseif ($db_department === 'Admin Office' && $db_designation === "IT Handler") {
                header("Location: https://m.tsh.edu.in/adminOffice/admin.html", true, 301);
            }
            elseif ($db_department === 'Admin Office' && $db_designation === "IT Head") {
                header("Location: https://m.tsh.edu.in/m/adminOffice/head/it_head.html", true, 301);
            }
            elseif ($g_email == 'test1@tsh.edu.in') {
                header("Location: https://m.tsh.edu.in/adminOffice/head/it_head.html", true, 301);
            }
            elseif ($g_email == 'gknarang@thescholarshome.com') {
                header("Location: https://m.tsh.edu.in/owners/owners-main.html", true, 301);
            }
            elseif ($g_email == 'npsnarang@tsh.edu.in') {
                header("Location: https://m.tsh.edu.in/owners/owners-main.html", true, 301);
            }
            elseif ($g_email == 'nishaparmar@thescholarshome.com') {
                header("Location: https://m.tsh.edu.in/principal/principal-main.html", true, 301);
            }
            else {
